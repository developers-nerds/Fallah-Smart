// List of country codes with flags, names, and dial codes
const countryCodes = [
  ...
  { name: 'Congo (DRC)', flag: '🇨🇩', code: 'CD', dial_code: '+243' },
  { name: 'Congo (Republic)', flag: '🇨🇬', code: 'CG', dial_code: '+242' },
  ...
  { name: 'Dominican Republic', flag: '🇩🇴', code: 'DO', dial_code: '+1' },
  ...
  { name: 'Vatican City', flag: '🇻🇦', code: 'VA', dial_code: '+379' },
