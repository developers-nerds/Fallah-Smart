...
const CropsLessons = () => {
  ...
  const lessons: Lesson[] = [
    {
      id: 1,
      title: 'زراعة القمح',
      description: 'تعلم أساسيات زراعة القمح وطرق العناية به',
      type: 'video',
    ...
    },
    {
      id: 2,
      title: 'زراعة الزيتون',
      description: 'دليل شامل لزراعة أشجار الزيتون والعناية بها',
      type: 'quiz',
    },
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.header}>دروس زراعة المحاصيل</Text>
